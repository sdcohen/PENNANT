...
template<typename T>
void gathervImpl(const T* x, const int numx, T* y, const int* numy) {
...
template<>
void gatherv(const double2* x, const int numx, double2* y, const int* numy) {
  gathervImpl(x, numx, y, numy);
}

template<>
void gatherv(const double* x, const int numx, double* y, const int* numy) {
  gathervImpl(x, numx, y, numy);
}

template<>
void gatherv(const int* x, const int numx, int* y, const int* numy) {
  gathervImpl(x, numx, y, numy);
}
